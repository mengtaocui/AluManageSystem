...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="newsModuleList" title="新闻模块" actionUrl="newsModuleController.do?datagrid" idField="id" fit="true">
   <t:dgCol title="编号" field="id" hidden="true"></t:dgCol>
   <t:dgCol title="类型id" field="newsTypeId"   width="120"></t:dgCol>
   <t:dgCol title="模块名称" field="name"   width="120"></t:dgCol>
   ...
   <t:dgDelOpt title="删除" url="newsModuleController.do?del&id={id}" urlclass="ace_button"  urlfont="fa-trash-o"/>
   ...
   <t:dgToolBar title="查看" icon="icon-search" url="newsModuleController.do?addorupdate" funname="detail"></t:dgToolBar>
  </t:datagrid>
  </div>
 </div>