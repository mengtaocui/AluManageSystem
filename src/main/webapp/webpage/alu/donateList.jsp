...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="donateList" title="捐赠" actionUrl="donateController.do?datagrid" idField="id" fit="true" queryMode="group" >
   ...
   <t:dgFunOpt funname="handleApplyPass(id)" operationCode="apply" exp="checkStatus#eq#0" title="通过" urlStyle="background-color: #449d44;" urlclass="ace_button"  urlfont="fa-check"></t:dgFunOpt>
   <t:dgFunOpt funname="handleApplyRefuse(id)" operationCode="refuse" exp="checkStatus#eq#0" title="拒绝" urlStyle="background-color: #f0ad4e;" urlclass="ace_button"  urlfont="fa-close"></t:dgFunOpt>
