...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="newsTypeList" title="新闻类型" actionUrl="newsTypeController.do?datagrid" idField="id" fit="true">
   <t:dgCol title="编号" field="id" hidden="true"></t:dgCol>
   <t:dgCol title="类型名称" field="name"   width="120"></t:dgCol>
   ...
   <t:dgToolBar title="查看" icon="icon-search" url="newsTypeController.do?addorupdate" funname="detail"></t:dgToolBar>
  </t:datagrid>
  </div>
 </div>