...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="newsList" title="新闻" actionUrl="newsController.do?datagrid" idField="id" fit="true">
   <t:dgCol title="编号" field="id" hidden="true"></t:dgCol>
   <t:dgCol title="类型id" field="newsTypeId"   width="120"></t:dgCol>
   <t:dgCol title="newsModuleId" field="newsModuleId"   width="120"></t:dgCol>
